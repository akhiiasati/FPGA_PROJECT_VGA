## This file is a general .xdc for#set_property PACKAGE_PIN V16 [get_ports {sel_module[0]}]
...
#set_property IOSTANDARD LVCMOS33 [get_ports {sel_module[3]}] the Basys3 rev B board
